...
import { Shield, Mail, User, Building, Hash, Clock, CheckCircle, Lock, LogOut } from 'lucide-react';
    ...
    <div className="p-6 space-y-6 max-w-2xl">
      ...
      <Card>
        ...
        <div className="space-y-2">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg bg-danger/10 hover:bg-danger/20 text-sm text-danger font-medium border border-danger/30 transition-colors text-left"
          >
            <LogOut size={15} />
            Sign Out
          </button>
