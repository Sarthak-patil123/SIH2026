...
export let mockCases: Case[] = [
  ...
  },
  {
    ...
    applicantName: 'Rohit Mishra',
    applicantDob: '16/08/1997',
    status: 'FLAGGED',
    riskScore: 67,
    riskLevel: 'HIGH',
    officerId: 'officer-1',
